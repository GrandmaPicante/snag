...
object Configuration {
  ...
  implicit private val TorrentDayFormat = jsonFormat2(TorrentDay.apply)
  implicit private val TheTVDBFormat = jsonFormat2(TheTVDB.apply)
  private val ConfigurationFormat = jsonFormat2(Configuration.apply)
